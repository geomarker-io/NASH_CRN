...
acs_racial_ses_ICE <- get_acs(
  ...
  group_by(GEOID) %>%
  summarize(
    n_diff = sum(estimate[variable == "B19001H_014"], estimate[variable == "B19001H_015"], estimate[variable == "B19001H_016"], estimate[variable == "B19001H_017"]) -
...
acs_data <- reduce(
  .x = list(
    acs_public_assistance, acs_poverty, acs_unemployment,
...
data2010 <- reduce(
  .x = list(all_tracts, acs_data, ct_data, og_data),
